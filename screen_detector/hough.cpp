...
void order_point(Point p[5][1000])
{
	...
	cout << endl;
	cout << "原图 right_but" << Pright_but.x << "    " << Pright_but.y << endl;
	cout << endl;
	cout << "原图 right_top" << Pright_top.x << "    " << Pright_top.y << endl;
	cout << endl;
	cout << "原图 left_but" << Pleft_but.x << "    " << Pleft_but.y << endl;
	cout << endl;
	cout << "原图 left_top" << Pleft_top.x << "    " << Pleft_top.y << endl;
}
...
int main(int argc, char *argv[])
{
	...
	cout << "长度：" << dst.cols << " " << kx << "  " << "          宽度： " << dst.rows << "  " << ky << endl;
